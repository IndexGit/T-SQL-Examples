...
BEGIN
	...
	-------------------------------------------------------------------------------------
	SELECT 
		@PersentMIN = 15,		-- минимальный % для выполнения дефрагментации [15]
		@PersentRebuild = 40,	-- пороговый % для REBUILD [40]
		@AllIndexes = 0,		-- работа по каждому индексу (0) или сразу по всем (1) [0]
		@MaxRunTimeSec = 60*35,	-- Кол-во секунд максимум на выполнение дефрагментации [35*60] -- 35 минут
		@PageCountMIN = 50		-- Минимальный размер индекса в страницах для дефрагментации [50]
	-------------------------------------------------------------------------------------
	DECLARE
		@StartTime datetime,
		@CurrTime datetime,
